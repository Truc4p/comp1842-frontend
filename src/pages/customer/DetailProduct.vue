            ...
            <div class="p-8 lg:p-12">
              ...
              <div class="mb-6">
                <div class="flex items-center gap-4">
                  ...
                  <span class="text-gray-500">{{ product.stockQuantity }} {{ t('productsAvailable') || 'sản phẩm có sẵn' }}</span>
                </div>
              </div>
              ...
              <div class="pt-6">
                <div class="flex flex-col sm:flex-row gap-4">
                  <button 
                    :disabled="product.stockQuantity <= 0 || buttonState === 'loading'"
                    @click="addToCart"
                    :class="[
                  ...
                  >
                    <!-- Loading Spinner -->
                    <svg v-if="buttonState === 'loading'" class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                      <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    
                    <!-- Cart Icon for default and success states -->
                    <svg v-else-if="buttonState === 'default' || buttonState === 'success'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    
                    <!-- Check Icon for success state -->
                    <svg v-if="buttonState === 'success'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
